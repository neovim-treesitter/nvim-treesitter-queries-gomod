# nvim-treesitter-queries-gomod

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gomod/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gomod/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gomod**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gomod",
...
- [ ] Changes are scoped to `gomod` — do not include files for other languages
